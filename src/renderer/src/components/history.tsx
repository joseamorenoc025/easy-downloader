      ...
      <div className="relative overflow-hidden rounded-xl aspect-video bg-muted shadow-md group-hover:shadow-xl transition-shadow duration-300">
        ...
        {thumb && !imgError ? (
          ...
          >
            ...
            <span className="text-white/80 text-[10px] font-medium px-2 text-center truncate w-full text-center">{entry.title}</span>
          </div>
        ) : (
          ...
          <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-violet-900/60 to-slate-900">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.4)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Format badge */}
        <span className={`absolute top-2 right-2 rounded-md px-1.5 py-0.5 text-[10px] font-bold tracking-wide ${
